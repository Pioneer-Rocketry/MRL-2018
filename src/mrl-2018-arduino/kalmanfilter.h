/**
*	kalman.h
*	Defines the kalman filter operations
...
public:
	...
	/*	Slightly modified version of the madgwick quaternion update function
	  	that allows the orientation to be input via the quaternion struct
	*/
