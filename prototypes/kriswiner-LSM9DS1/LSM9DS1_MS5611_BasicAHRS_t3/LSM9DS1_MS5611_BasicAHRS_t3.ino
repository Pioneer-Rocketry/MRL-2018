...
void eulerAnglesOrientation()
{
  ...
  //Serial.printf("%f, %f, %f, %d\n", x * 180.0f/PI, y * 180.0f/PI, z * 180.0f/PI, millis() % 1000);
...
{  
  ...
  //eulerAnglesOrientation();


  Serial.printf("q0 = %f.02, q1 = %f.02, q2 = %f.02, q3 = %f.02\n", q[0], q[1], q[2], q[3]);
